   ...
   <%@include file="navbar_wli.jsp"%>
    ...
    <body>
        ...
        <hr>
                ...
                <div id="box">
                                <center><h3>Pie</h3></center>
                                <form method="POST" action="PieChart.jsp" enctype="multipart/form-data">
                           ...
                           <input type="submit"  value="UploadFile">
                                ...
                                <br>
                                <br>
                                  <form method="POST" action="PieChart.jsp">
    ...
    <script src="js/sb-admin.min.js"></script>
         ...
         <%
             try{
                 session.setAttribute("page", "PieChart.jsp");
    ...
    <%
        ...
        dataset.setValue(tem, new Double(Double.parseDouble(tem1)));
        }
         int width = 640;  
      int height = 480;
      JFreeChart chart;
