   ...
   <%@include file="navbar_wli.jsp"%>
    ...
    <body>
        ...
        <hr>
                ...
                <div id="box">
                                <center><h3>Bar</h3></center>
                                 <form method="POST" action="Bar.jsp" enctype="multipart/form-data">
    ...
    <script src="js/sb-admin.min.js"></script>
         ...
         <%
             try{
                 session.setAttribute("page", "Bar.jsp");
    ...
    <%
        ...
        String tem1 = itemValue[j]+ "";
         dataset.setValue(Float.parseFloat(tem1),tem, group);
        }
         int width = 640;  
      int height = 480;
       JFreeChart chart = ChartFactory.createBarChart3D(title, x_axis,y_axis,dataset);
