   ...
   <%@include file="navbar_wli.jsp"%>
    ...
    <body>
        ...
        <hr>
                ...
                <div id="box">
                                <center><h3>Line</h3></center>
                                 <form method="POST" action="Line.jsp" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="usr" name="title">
                                    ...
                                    <input type="text" class="form-control" id="xaxisinput" name="x-axis" onkeyup="xaxischange()">
                                  </div>
                                  <div class="form-group">
                                        <label for="usr">Y-Axis:</label>
                                        <input type="text" class="form-control" id="yaxisinput" name="y-axis" onkeyup="yaxischange()">
                                      </div>
                                      <h4>Data Set:</h4>
                                      <div class="form-group">
                                      ...
                                      <table id="divTable" class="table-bordered article" width="100%">
                                            <tr>
                                                <th>S No.</th>
                                                <th id="xaxis">X-Axis</th>
                                                <th id="yaxis">Y-Axis</th> 
                                            </tr>
                                      </table>
           ...
           <script>
              function xaxischange(){
                  if(document.getElementById("xaxisinput").value==""){
                      document.getElementById("xaxis").innerHTML = "X-Axis"
                  }else{
                document.getElementById("xaxis").innerHTML =  document.getElementById("xaxisinput").value;
               }
           }
               function yaxischange(){
                if(document.getElementById("yaxisinput").value==""){
                      document.getElementById("yaxis").innerHTML = "Y-Axis"
                  }else{
                document.getElementById("yaxis").innerHTML =  document.getElementById("yaxisinput").value;
               }
               }
          var flag = 2;
    ...
    <script src="js/sb-admin.min.js"></script>
         ...
         <%
             try{
                 String rf = request.getParameter("rowstart");
                String re =request.getParameter("rowend");
                String cf = request.getParameter("colfirst");
              //  out.print(cf+"  " + re + "  " + rf);
                 session.setAttribute("page", "Line.jsp");
    ...
    <%
        ...
        String tem1 = itemValue[j]+ "";
         dataset.setValue(Float.parseFloat(tem1),x_axis, tem);
        }
         int width = 640;  
      int height = 480;
      ...
      upload.setSizeMax( maxFileSize );
       List fileItems = upload.parseRequest(request);
		...
		Workbook wb = Workbook.getWorkbook(fs);
                   ...
                   int rowstart = 1;
                           int rowend=totalNoOfRows;
                           if(rf!=null){rowstart=Integer.parseInt(request.getParameter("rowstart"));}
                           if(re!=null){rowend=Integer.parseInt(request.getParameter("rowend"));}
